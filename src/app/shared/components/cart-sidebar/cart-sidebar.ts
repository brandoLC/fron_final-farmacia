      ...
      <div class="border-t border-gray-200 p-4 space-y-4 bg-white">
        ...
        <div class="space-y-2">
          ...
          <div class="flex justify-between text-sm text-green-600">
            ...
            <span>-S/{{ cartService.descuentos() | number : '1.2-2' }}</span>
          </div>
          }
          ...
          <div class="flex justify-between text-sm">
            ...
            <span class="font-medium">
              ...
              <span>S/{{ cartService.envio() | number : '1.2-2' }}</span>
              }
            </span>
          </div>
          ...
          <div class="flex justify-between text-sm">
            ...
            <span class="font-medium"
              >S/{{ cartService.impuestos() | number : '1.2-2' }}</span
            >
          </div>
          ...
          <div class="border-t border-gray-200 pt-2">
            <div class="flex justify-between">
              ...
              <span class="text-lg font-bold text-green-600"
                >S/{{ cartService.total() | number : '1.2-2' }}</span
              >
            </div>
          </div>
        </div>
